                ...
                <Scroll :listen="viewData" ref="scroll">
                    <div class="table_body">
                        <div class="row" v-for="(d,i) in viewData">
                            ...
                            <div class="column" style="width:120px;"><span class="overflow clickItem" style="width:120px;" @click="collectChart(d)">{{d.collect}}</span></div>
...
export default {
  ...
  data () {
    return {
      ...
      bodyH:0,
      data:[
        {code:'53011135000127',name:'重庆智多测试设备',firm:'重庆爱思网安',region:'南岸区',kind:'severity',state:'online',time:'30分钟前',collect:6000,reasion:'场所已离线24小时',noteway:'自动通知',handlerState:'自动通知'},
        {code:'53011135000127',name:'重庆智多测试设备',firm:'重庆爱思网安',region:'南岸区',kind:'general',state:'online',time:'30分钟前',collect:6000,reasion:'场所已离线24小时',noteway:'自动通知',handlerState:'自动通知'},
        {code:'53011135000127',name:'重庆智多测试设备',firm:'重庆爱思网安',region:'南岸区',kind:'ignore',state:'online',time:'30分钟前',collect:6000,reasion:'场所已离线24小时',noteway:'自动通知',handlerState:'自动通知'},
      ],
      blnLoading:false,
      pageIndex:0,
      placeOrder:false,
