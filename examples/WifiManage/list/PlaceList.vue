            ...
            <div class="option_bar">
                ...
                <div class="item">
                    <span>场所类型:</span><div style="display:inline-block;">
                        <el-select v-model="netsiteType" placeholder="请选择" :clearable="true">
                            <el-option
                ...
                <Scroll :listen="data" ref="scroll">
                    <div class="table_body">
                        <div class="row" v-for="d in data">
                            ...
                            <div class="column" style="width:150px;"><span class="overflow clickItem" style="width:150px;" :title="`在线:${d.declareTerminal}/异常:${d.detectionTerminal}/离线:${d.onlineTerminal}`" @click="terminalDetail(d)">
                            ...
                            <div class="column" style="width:100px;" :title="d.kind"><span class="overflow" style="width:100px;">{{d.kind}}</span></div>
    ...
    converData(d){
        return _.map(d,c=>{
            ...
            return {
                    ...
                    declareTerminal:c.online_device,                //在线设备
                    detectionTerminal:c.abnormal_device,            //异常设备
                    onlineTerminal:c.offline_device,                //离线设备
                    time:c.capture_time_desc,           //最近联系时间
                    collect:c.last_upload_num,          //昨日采集
                    businessState:c.business_state,     //营业状态
                    kind:c.netsite_type,                //场所类型
