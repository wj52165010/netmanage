    ...
    <div class="PlaceDetail">
        <div class="PlaceDetail_container">
            ...
            <div class="row">
                ...
                <div class="col-md-2 text-right">场所类型:</div><div class="col-md-4 ">交通枢纽</div>
            </div>

            <div class="row">
                <div class="col-md-2 text-right">经营性质:</div><div class="col-md-4 ">经营  </div>
                <div class="col-md-2 text-right">最近联系时间:</div><div class="col-md-4 ">2017-12-14 16:18:09</div>
            </div>

            <div class="row">
                <div class="col-md-2 text-right">营业时间:</div><div class="col-md-4 ">08:00 - 20:00  </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-2 text-right">负责人:</div><div class="col-md-2 ">张三</div>
                <div class="col-md-2 text-right">联系电话:</div><div class="col-md-2 ">138xxxxxxxx</div>
            </div>
