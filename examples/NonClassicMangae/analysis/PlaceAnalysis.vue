...
import {BODY_RESIZE,GetFirm,SiteHisPercentage,HisPercentageExport,LastPercentage,getDictTables,DeviceHisPercentageExport,DeviceHisPercentage} from '../../../store/mutation-types'
...
export default {
  ...
  data () {
    return {
      ...
      microprobe_type:DataSource['非经营'],//数据来源
    }
  },
  watch:{
