...
<template>
    <div class="PlaceDetail">
        <div class="PlaceDetail_container">
            ...
            <div class="row">
                <div class="col-md-2 text-right">上网方式:</div><div class="col-md-4 ">专网、真实IP地址  </div>
                <div class="col-md-2 text-right">申报IP:</div><div class="col-md-4 ">58.17.252.3</div>
            </div>

            <div class="row">
                <div class="col-md-2 text-right">终端概况:</div><div class="col-md-4 ">申报终端100/检测终端100/在线终端20  </div>
                <div class="col-md-2 text-right">最近联系时间:</div><div class="col-md-4 ">2017-12-14 16:18:09</div>
            </div>

            <div class="row">
                <div class="col-md-2 text-right">所属派出所:</div><div class="col-md-4 ">南坪镇派出所  </div>
            ...
            <div class="row">
                <div class="col-md-2 text-right">法人姓名:</div><div class="col-md-2 ">李四  </div>
            ...
            <div class="row">
                <div class="col-md-2 text-right">网监部门:</div><div class="col-md-2 ">重庆网安  </div>
