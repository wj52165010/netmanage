        ...
        <div class="pos_container">
            <div class="kind_container">
                <div class="sideMenu_conatiner">
                    <div class="slidee">
                        <div class="kind_item" v-for="(menu,index) in menus" v-if="menu.id==3 || menu.id==7"  :class="{active:curIndex==index}"  @mouseenter="menu_mouseenter(menu,index)" @mouseleave="menu_mouseleave()">
