// Canvas加载中动画插件
import Sonic from '../../static/sonic.js'
...
module.exports =function play(id,loaderIndex){
    a = new Sonic(loaders[loaderIndex] || loaders[0]);
    document.getElementById(id).appendChild(a.canvas);
    a.play();
};