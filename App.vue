<template>
  <div id="app" class="app">
    ...
    <div class="index_footer" v-if="true">
      ...
      <div style="float:right;padding-right:10px;">Copyright © 2018 重庆智多信息发展有限公司.版权所有 当前版本:<span style="color:rgb(3, 171, 103);"><span style="cursor:pointer;" @click="banbenClick()">1.0.4-alphal</span></span></div>
    </div>
    <!-- 快搜 -->
    <Kuaiso />
    <!-- 全局加载中弹出层 -->
