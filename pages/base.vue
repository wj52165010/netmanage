            ...
            <div class="detail_filter" v-show="pageIndex==1">
                <div style="height:100%;float:left;" v-show="countIndex==0">
                    ...
                    <div style="width:200px;display:inline-block;">
                        <el-select v-model="dataSource" clearable placeholder="数据来源">
                            <el-option
...
import {Customer,VidCounter,VidMac,SiteCount,DataCount,EquipmentCount,MobileCount,ExportOnlineCount,ExportDetailCount,DataTotal,DetailListCount,DetailListExport,
        FirmCount,BODY_RESIZE,Trigger_RESIZE,FirmSiteCount,FirmEquipmentCount,GetRegion,GetFirm,GetMicroprobe,SiteOnlineRate} from '../store/mutation-types'
...
<style scoped lang="less">
  ...
  .BasePage .filter_container{position:absolute;right:0px;width:100%;height:40px;padding-left:200px;padding-right:10px;}
